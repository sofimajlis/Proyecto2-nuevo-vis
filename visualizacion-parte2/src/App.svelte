...
// FILTROS
  ...
  // Cargar viajes previos desde localStorage (si existen)
  if (localStorage.getItem('viajesFormulario')) {
    viajesFormulario = JSON.parse(localStorage.getItem('viajesFormulario'));
  }

  // Agregar un nuevo viaje al array y guardarlo en localStorage
  function agregarViaje() {
    ...
    localStorage.setItem('viajesFormulario', JSON.stringify(viajesFormulario));
